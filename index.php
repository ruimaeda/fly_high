...
<link rel="stylesheet" type="text/css"  href="css/index_bootstrap.css">
  ...
  <div class="container box">
    ...
    <div class="row">
      <div class="col-md-4 col-sm-6">
        <div class="service">
          <h3>行きたい国や旅行スタイル<br>に合わせてセールを受信</h3>
          <i class="fa fa-map-marker" aria-hidden="true"></i>
          <p>気になっていたあの国やあなたの旅行スタイルを<br>登録しておくと、登録内容に合わせて航空券の<br>セール情報を受け取ることができます。</p>
        </div>
      </div>
      <div class="col-md-4 col-sm-6">
        <div class="service">
          <h3>34ヶ国、年間50回<br>セールを受信</h3>
          <i class="fa fa-bullhorn"></i>
          <p>アジアからヨーロッパまで34ヶ国分12の航空会社<br>のセールを一括して受け取ることができます。<br>思いもよらない旅行先が見つかるかも。<br></p>
        </div>
      </div>
      <div class="col-md-4 col-sm-6">
        <div class="service">
          <h3>セール開始前に<br>情報を受け取る</h3>
          <i class="fa fa-rss" aria-hidden="true"></i>
          <p>気づいたら航空券のセールが終わっていた！<br>そんなことはありませんか？FLY HIGHで<br>セールの情報を事前に受け取って、<br>格安で航空券を予約しましょう。</p>
        </div>
      </div>
    </div>
  </div>
    ...
    <!-- 三角ありの3STEPバージョン -->
      ...
      <div>
        <ul class="msr_flow04">
          ...
          <div class="col-md-3 col-sm-6">
              <li class="active none"><span>STEP4</span><br>
                <i class="fa fa-plane" aria-hidden="true"></i><br>
