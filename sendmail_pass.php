...
//配列を設定する
$to = $_SESSION['email'];
$subject = "FLYHIGH[フライハイ] パスワードの再登録ページをお送りします";
$body = "パスワードの再設定はこちらから ".$_SESSION['hashurl'];
$fromname = "FLYHIGH";
...
// SMTPを使ってメール送信関数
function phpmailersend ( $to, $subject, $body, $fromname, $fromaddress, $ccaddress="", $bccaddress=""){
  ...
  <div class="intro-body bg">
    <div class="container box">
      <h1>メール送信結果</h1>
        ...
        <h2>入力いただいたメールアドレスにパスワード設定画面をお送りしました</h2>
        <?php }else{ ?>
